...
export class TransporteSchema1787524209000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "transporte" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "nombre" character varying(100), "cedula" character varying(50), "marca" character varying(100), "modelo" character varying(100), "placa" character varying(50), CONSTRAINT "PK_transporte" PRIMARY KEY ("id"))`);
