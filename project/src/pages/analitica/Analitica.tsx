...
export const Analitica: React.FC = () => {
  ...
  const cargando = !pedidos || !oportunidades || !actividades || !clientes;
              ...
              <div>
                ...
                {metasMes.objetivo_ventas ? (
                  <p className="text-xs text-gray-400">
                    Meta del mes: {formatCurrencyCompacto(metasMes.objetivo_ventas)}
                  </p>
                ) : null}
              </div>
                ...
                {actividadesPorTipo.map((actividad, index) => {
                  const ancho =
                    actividad.porcentaje !== null
                      ...
                      : (actividad.cantidad / maxCantidadActividades) * 100;
                  return (
                    <div
                      key={actividad.tipo}
                      className="flex items-center justify-between"
              ...
              <div className="space-y-6">
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-sm font-semibold text-gray-900">
                      {`${porcentaje(actividadesCompletadasMes, totalMetas()).toFixed(
                        2,
                      )}%`}
                    </span>
                  </div>
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-sm font-semibold text-gray-900">
                      {`${porcentaje(recomprasMesActual, compradoresMes).toFixed(
                        2,
                      )}%`}
                    </span>
                  </div>
